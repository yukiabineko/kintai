...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post attendances_url, params: { attendance: { finish: @attendance.finish, start: @attendance.start, worked_on: @attendance.worked_on } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { finish: @attendance.finish, start: @attendance.start, worked_on: @attendance.worked_on } }
